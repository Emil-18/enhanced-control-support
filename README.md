...
* Download: [Stable version](https://github.com/Emil-18/enhanced-control-support/releases/download/v1.2.2/enhancedControlSupport-1.2.2.nvda-addon).
...
* Added ework in progress  toolbar support.
### v1.2.1
