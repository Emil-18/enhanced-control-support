...
* Last ned: [Stabil versjon](https://github.com/emil-18/enhanced-control-support/releases/download/v1.2.2/enhancedcontrolsupport-1.2.2.nvda-addon).
...
* Lagt til work in progress verktøylinje støtte
